		...
		<div class="row gutters text-muted ">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="first_name" placeholder="First Name" value="{{ Auth::user()->first_name}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="middle_name" placeholder=" Middle Name" value="{{ Auth::user()->middle_name}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="Last Name" placeholder="Last Name" value="{{ Auth::user()->last_name}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<select class="custom-select form-control text-muted "  disabled >
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="nationality" placeholder="Nationality" value="{{ Auth::user()->userdetail->nationality}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="religion" placeholder="Religion"value="{{ Auth::user()->userdetail->religion}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="date_of_birth" placeholder="Date of Birth"value="{{ Auth::user()->userdetail->date_of_birth}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="place_of_birth" placeholder="Place of Birth"value="{{ Auth::user()->userdetail->place_of_birth}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone_number" placeholder="Phone Number"value="{{ Auth::user()->userdetail->phone_number}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				...
				<input type="email" class="form-control" id="email" placeholder="Email Address" value="{{ Auth::user()->email}}" disabled>
				</div>
			</div>
		</div>
		...
		<div class="row gutters text-muted">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="Street" placeholder="Enter Street"value="{{ Auth::user()->userdetail->street}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="ciTy" placeholder="Enter City" value="{{ Auth::user()->userdetail->city}}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="province" placeholder=" Province"value="{{ Auth::user()->userdetail->province }}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="sTate" placeholder=" State"value="{{ Auth::user()->userdetail->state }}" disabled>
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="phone_number">Phone Number</label>
					<input type="text" class="form-control" id="phone_number" placeholder=" State"value="{{ Auth::user()->userdetail->phone_number }}" disabled>
				</div>
			</div>
