		...
		<div class="row gutters text-muted ">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="first_name" placeholder="First Name" wire:model.defer="input.first_name" >
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="middle_name" placeholder=" Middle Name" wire:model.defer="input.middle_name" >
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="Last Name" placeholder="Last Name" wire:model.defer="input.last_name" >
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<select class="custom-select form-control text-muted"wire:model.defer="input.sex">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="nationality" placeholder="Nationality" wire:model.defer="input.nationality">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="religion" placeholder="Religion"wire:model.defer="input.religion" >
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="date" class="form-control" id="date_of_birth" placeholder="Date of Birth" wire:model.defer="input.date_of_birth">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="place_of_birth" placeholder="Place of Birth"wire:model.defer="input.place_of_birth" >
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone_number" placeholder="Phone Number" wire:model.defer="input.phone_number">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="email" class="form-control" id="email" placeholder="Email" wire:model.defer="input.email">
				</div>
			</div>
		</div>
		...
		<div class="row gutters text-muted">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="Street" placeholder="Enter Street" wire:model.defer="input.street">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="ciTy" placeholder="Enter City" wire:model.defer="input.city">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="name" class="form-control" id="province" placeholder=" Province" wire:model.defer="input.province">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="sTate" placeholder=" State" wire:model.defer="input.state">
				</div>
			</div>
