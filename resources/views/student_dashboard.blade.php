...
<div class="antialiased sans-serif bg-gray-100 z-50">
<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
  ...
  <!-- Modal -->
  <div style=" background-color: rgba(0, 0, 0, 0.8)" class="fixed z-50 top-0 right-0 left-0 bottom-0 h-full w-full" x-show.transition.opacity="openEventModal">
